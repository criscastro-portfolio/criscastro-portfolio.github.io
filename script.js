...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const whatsappLogo = document.querySelector('path[alt="skype logo"]');

  const lightLogos = {
    github: "assets/onlinejob_dark.png",
    linkedin: "assets/whatsapp_dark.png",
    email: "assets/gmail_dark.png",
    theme: "assets/theme_light.png",
  };

  const darkLogos = {
    github: "assets/onlinejob.png",
    linkedin: "assets/whatsapp.png",
